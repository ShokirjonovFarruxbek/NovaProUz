...
const HomeEn: React.FC = () => {
  ...
  useEffect(() => {
    ...
    setCaseStudies([
      { id: 1, image: '/path/to/caseStudy1.jpg', title: 'Case Study 1', description: 'Description of Case Study 1', industry: 'Manufacturing' },
      { id: 2, image: '/path/to/caseStudy2.jpg', title: 'Case Study 2', description: 'Description of Case Study 2', industry: 'Retail' },
      { id: 3, image: '/path/to/caseStudy3.jpg', title: 'Case Study 3', description: 'Description of Case Study 3', industry: 'Logistics' },
    ]);
    setArticles([
      { id: 1, image: '/path/to/article1.jpg', title: 'Article 1', author: 'Author 1', readTime: '5 min', description: 'Description of Article 1' },
      { id: 2, image: '/path/to/article2.jpg', title: 'Article 2', author: 'Author 2', readTime: '7 min', description: 'Description of Article 2' },
      { id: 3, image: '/path/to/article3.jpg', title: 'Article 3', author: 'Author 3', readTime: '10 min', description: 'Description of Article 3' },
    ]);
  }, []);
