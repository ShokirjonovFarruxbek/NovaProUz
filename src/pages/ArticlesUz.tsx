...
const ArticlesUz = () => {
  ...
  const articles = [
    {
      id: 1,
      title: 'Kompaniyangiz samaradorligini oshirishning 5 ta usuli',
      description: 'Asosiy biznes sohalarida avtomatlashtirish qanday qilib samaradorlikni sezilarli darajada oshirishi va operatsion xarajatlarni kamaytirishi mumkinligini bilib oling.',
    ...
    },
    {
      ...
      description: 'Biznesingizning o\'ziga xos ehtiyojlari va maqsadlariga mos keladigan avtomatlashtirish yechimlarini tanlash bo\'yicha keng qamrovli qo\'llanma.',
      image: '/images/Blog_2.avif',
      author: 'Daniyel Uilson',
      date: '15 mart 2025',
      readTime: '6'
    },
    {
      ...
      description: 'Avtomatlashtirish biznesingizni samarali rivojlantirishga va bozorda raqobatbardosh ustunlikni saqlab qolishga qanday yordam berishini o\'rganing.',
      image: '/images/Blog_3.avif',
      author: 'Mixayil Braun',
      date: '1 mart 2025',
      readTime: '8'
    }
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {articles.map((article) => (
            <motion.article
              ...
              onClick={() => navigate(`/uz/article/${article.id}`)}
            >
